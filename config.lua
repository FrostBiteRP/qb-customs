...
bennyGarages = {
    ...
    [4] = {coords = vector4(-31.89, -1066.29, 28.4, 163.92), blip = true, useJob = true, job = {"mechanic"}}, -- Benny's next to PDM
    [5] = {coords = vector4(543.93, -179.2, 53.49, 269.86), blip = true, useJob = true, job = {"autoexotic"}} -- Auto Exotics
}
